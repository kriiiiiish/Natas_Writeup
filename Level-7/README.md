...
So we look at the source code to find any possible paths to the file and we can clearly the the path is given as a hint. 

So we attach the path in place of about or home (index.php?page=about) and we get the password. 
